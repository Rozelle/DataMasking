...
public class LastNameSubstitution {
	Connection connection;
	String tableName, columnName;


	public LastNameSubstitution(Connection connection, String tableName, String columnName) {
	...
	public ArrayList<String> getList() throws Exception {
		...
		ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream(LASTNAMES_FILE));
